    ...
    !(function (e) {
        ...
        function (t, r, n) {
                ...
                y = function e(t, r, n) {
                    ...
                    var o = v(r),
                        ...
                        f = {
                            ...
                            array: function (e) {
                                for (var t = 0; t < e.length; t++) (o = v(e[t])), f[o](e[t]);
                            },
                            function: function (e) {
                                (e = e()), (o = v(e)), f[o](e);
                            },
                    ...
                    for (var c in s)
                        if (s.hasOwnProperty(c)) {
                            var d = m(c),
                                p = Array.isArray(s[c]) ? C(s[c].join(" ").split(" ")).join(" ") : s[c];
                            u.setAttribute(d, p);
                        }
                    return (
                        r && f[o](r),
                ...
                A = function (e) {
                    ...
                    if (t)
                        for (var n = t.getElementsByTagName("field"), o = 0; o < n.length; o++) {
                            ...
                            a && a.length && (i.values = x(a)), r.push(i);
                        }
                    return r;
                },
                O = function (e) {
                    ...
                    Array.isArray(t) || (t = [t]),
                        t.forEach(function (t) {
                            var n = "href",
                                o = t,
                                i = "";
                            if (("object" == typeof t && ((n = t.type || (t.style ? "inline" : "href")), (i = t.id), (t = "inline" == n ? t.style : t.href), (o = i || t.href || t.style)), !N(o, "css"))) {
                                if ("href" == n) {
            ...
            var H = {
                ...
                merge: function e(t, r) {
                    ...
                    for (var o in r) n.hasOwnProperty(o) && (Array.isArray(r[o]) ? (n[o] = Array.isArray(t[o]) ? C(t[o].concat(r[o])) : r[o]) : "object" == typeof r[o] ? (n[o] = e(t[o], r[o])) : (n[o] = r[o]));
                    return n;
                },
                mobileClass: R,
                nameAttr: g,
        ...
        function (e, t, r) {
            ...
            var i = {
                    ...
                    allowStageSort: !0,
                    append: !1,
                    controlOrder: ["autocomplete", "checkbox-group", "checkbox", "date", "file", "number", "radio-group", "select", "text", "textarea"],
        ...
        function (t, r, n) {
                        ...
                        if (((u.multiple || "checkbox-group" === i) && (u.name = u.name + "[]"), "checkbox-group" === i && u.required && (this.onRender = this.groupRequired), delete u.title, r)) {
                            ...
                            for (var d = 0; d < r.length; d++) {
                                ...
                                var b = m,
                                    ...
                                    g = void 0 === h ? "" : h,
                                    v = p(b, ["label"]);
                                if (((v.id = u.id + "-" + d), (v.selected && !o) || delete v.selected, void 0 !== n && v.value === n && (v.selected = !0), c)) {
                                    var y = this.markup("option", document.createTextNode(g), v);
                                    e.push(y);
                                } else {
                                    var w = [g],
                                        x = "formbuilder-" + f;
                                    a && (x += "-inline"), (v.type = f), v.selected && ((v.checked = "checked"), delete v.selected);
                            ...
                            if (!c && l) {
                                ...
                                var L = {
                                    ...
                                    N = this.markup("input", null, E),
                                    S = [document.createTextNode("Other"), this.markup("input", null, L)],
                                    T = this.markup("label", S, { for: E.id }),
                                    D = this.markup("div", [N, T], { className: C });
                                e.push(D);
                            }
                        }
            ...
            o.a.register(["text", "file", "date", "number"], g), o.a.register(["text", "email", "tel"], g, "text");
            var y = (function (t) {
                var r, n;
                function o() {
                    return t.apply(this, arguments) || this;
        ...
        function (e, t, r) {
            ...
            e.exports = function (e, t, r) {
                ...
                function v(t) {
                    var r = s,
                        n = u;
                    return (s = u = void 0), (m = t), (c = e.apply(n, r));
                }
                function y(e) {
                    return (m = e), (d = setTimeout(x, t)), b ? v(e) : c;
                }
                function w(e) {
                    var r = e - p;
                    return void 0 === p || r >= t || r < 0 || (h && e - m >= f);
                }
                function x() {
                    var e = o();
                    if (w(e)) return A(e);
                    d = setTimeout(
                        ...
                        (function (e) {
                            var r = t - (e - p);
                            return h ? l(r, f - (e - m)) : r;
                        })(e)
                    );
                }
                function A(e) {
                    return (d = void 0), g && s ? v(e) : ((s = u = void 0), c);
                }
                function O() {
                    var e = o(),
                        r = w(e);
                    ...
                    return void 0 === d && (d = setTimeout(x, t)), c;
                }
                return (
                    (t = i(t) || 0),
                    n(r) && ((b = !!r.leading), (f = (h = "maxWait" in r) ? a(i(r.maxWait) || 0, t) : f), (g = "trailing" in r ? !!r.trailing : g)),
                        (O.cancel = function () {
                            void 0 !== d && clearTimeout(d), (m = 0), (s = p = u = d = void 0);
                        }),
                        (O.flush = function () {
                            return void 0 === d ? c : A(o());
                        }),
                        O
                );
            };
                    ...
                    return (
                        (r.startMoving = function (e, t) {
                            ...
                            (r.processOptions = function (e) {
                                ...
                                var a = [
                                    { type: "button", id: "clear", className: "clear-all btn btn-danger mt-4", events: { click: t.confirmRemoveAll.bind(t) } },
                                    {
                                        type: "button",
                                        id: "Add Program",
                                        className: "btn btn-primary save-template mt-4",
                                        events: {
                                            click: function (e) {
                                                const customFields = t.data.formData;
                                                ...
                                                if (programName.trim() == '' || session.trim() == '' || numberOfStudents.trim() == '' || programStatus.trim() == '' || details.trim() == '') {
            ...
            var O = function (e, t, r) {
                    ...
                    e.allowStageSort || C.sortable("disable"),
                        E.sortable({
                            ...
                            update: function (t, r) {
                                ...
                                r.item.parent()[0] === h.stage ? ((O.doCancel = !0), L(r.item)) : (O.setFieldOrder(E), (O.doCancel = !e.sortableControls));
                            },
                        });
                    var L = function (t) {
                    ...
                    e.showActionButtons && S.appendChild(h.formActions),
                        ...
                        r(h.controls).on("click", "li", function (e) {
                            var t = e.target,
                                n = r(t).closest("li");
                            (O.stopIndex = void 0), L(n), O.save.call(O);
                        });
                    var T = function (t, n) {
                            void 0 === n && (n = !1);
                            var o = {};
                        ...
                        B = function (e) {
                            var t,
                                ...
                                n = e.values,
                                o = e.name,
                                i = [j("a", f.a.get("addOption"), { className: "add add-opt" })],
                                a = [j("label", f.a.get("selectOptions"), { className: "false-label" })],
                            ...
                            var c = j("div", i, { className: "option-actions" }),
                                d = j(
                                    "ol",
                                    t.map(function (e) {
                                        return W(o, e, l);
                                ...
                                m = j("div", [d, c], { className: "sortable-options-wrap" });
                        ...
                        R = function (t) {
                            var r,
                                ...
                                a = {
                                    ...
                                    toggle: function () {
                                        return P("toggle", t, { first: f.a.get("toggle") });
                                    },
                                    inline: function () {
                                    ...
                                    other: function () {
                                        return P("other", t, { first: f.a.get("enableOther"), second: f.a.get("enableOtherMsg") });
                                    },
                                    options: function () {
                                        return B(t);
                                    },
                                    requireValidOption: function () {
                                        return P("requireValidOption", t, { first: " ", second: f.a.get("requireValidOption") });
                                    },
                                    multiple: function () {
                                        var e = {
                    ...
                    function I(e, t) {
                        ...
                        return (
                            ...
                            '<div class="form-group ' + e + '-wrap">' + p + ('<div class="input-wrap">' + j("select", c, d).outerHTML + "</div>") + "</div>"
                        );
                    }
                            ...
                            return (
                                (t += O.input({ value: e || "default", type: "hidden", className: "btn-style" }).outerHTML),
                                    ...
                                    m.d.btn.forEach(function (r) {
                                        ...
                                        e === r && n.push("selected");
                                        var o = j("button", f.a.get("styles.btn." + r), { value: r, type: "button", className: n.join(" ") }).outerHTML;
                                        t += o;
                                    }),
                        ...
                        Q = function (t, r, n) {
                            ...
                            if (
                                ...
                                var c = '<div class="input-wrap">' + l + "</div>",
                                    d = n ? "none" : "block";
                                "value" === t && (d = r.subtype && "quill" === r.subtype && "none"), (l = j("div", [u, c], { className: "form-group " + t + "-wrap", style: "display: " + d }));
                            }
                            return l.outerHTML;
                        },
                        V = function (e) {
                            ...
                            return (
                                ...
                                r.some(function (e) {
                                    return !0 === e;
                                }) || (n = P("required", e, { first: f.a.get("required") })),
                                    n
                            );
                        },
                        Y = function (t, n) {
                            ...
                            "hidden" === i && (a = f.a.get(i) + ": " + t.name);
                            var s = e.disabledFieldButtons[i] || t.disabledFieldButtons,
                                u = [
                                    j("a", null, { type: "remove", id: "del_" + b.lastID, className: "del-button btn icon-cancel delete-confirm", title: f.a.get("removeMessage") }),
                                    j("a", null, { type: "edit", id: b.lastID + "-edit", className: "toggle-form btn icon-pencil", title: f.a.get("hide") }),
                                    j("a", null, { type: "copy", id: b.lastID + "-copy", className: "copy-button btn icon-copy", title: f.a.get("copyButtonTooltip") }),
                                ];
                            s &&
                            Array.isArray(s) &&
                            ...
                            var c = [j("div", u, { className: "field-actions" })];
                            c.push(j("label", Object(p.t)(a), { className: "field-label" })), c.push(j("span", " *", { className: "required-asterisk", style: t.required ? "display:inline" : "" }));
                            var d = { className: "tooltip-element", tooltip: t.description, style: t.description ? "display:inline-block" : "display:none" };
                            c.push(j("span", "?", d)), c.push(j("div", "", { className: "prev-holder" }));
                            var m = j("div", [R(t), j("a", f.a.get("close"), { className: "close-field" })], { className: "form-elements" }),
                                g = j("div", m, { id: b.lastID + "-holder", className: "frm-holder", dataFieldId: b.lastID });
                            (o.currentEditPanel = g), c.push(g);
                            var v = j("li", c, { class: i + "-field form-field", type: i, id: b.lastID }),
                                y = r(v);
                        ...
                        W = function (e, t, r) {
                            ...
                            for (var a = o.length - 1; a >= 0; a--) {
                                ...
                                if (t.hasOwnProperty(l)) {
                                    ...
                                    (s.placeholder = f.a.get("placeholder." + l) || ""), "selected" === l && !0 === t.selected && (s.checked = t.selected), i.push(j("input", null, s));
                                }
                            }
                        ...
                        (C.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), function (e) {
                            ...
                            C.on("click touchstart", ".delete-confirm", function (t) {
                                ...
                                if (
                                    ...
                                    var s = j("h3", f.a.get("warning")),
                                        u = j("p", f.a.get("fieldRemoveWarning"));
                                    O.confirm(
                                        [s, u],
                                        function () {
