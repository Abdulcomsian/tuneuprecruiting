...
<body>
    ...
    <script>
        function copyToClipboard(element) {
            ...
            var notification = element.nextElementSibling;
        ...
        jQuery(function($) {
            ...
            document.getElementById('btnSubmit').addEventListener('click', function() {
                ...
                if ($('#program-id').length) {
                    ...
                    if (programName.trim() == '' || numberOfStudents.trim() == '' || programStatus.trim() ==
                        '' || details.trim() == '') {
        ...
        function updateNotificationList(notifications) {
            ...
            if (notifications && notifications.length > 0) {
                ...
                notifications.forEach(function(notification) {
                    ...
                    link.href = baseUrl + '/notification/view/' + notification.id;
                ...
                success: function(response) {
                    if (response && response.length > 0) {
                        ...
                        response.forEach(function(message) {
                            ...
                            var imgSrc = baseUrl + '/uploads/users_image/' + message
                                .profile_image; // Use profile image if available, else a default
                            ...
                            var h5 = $('<h5 class="mb-1">').html('<a>' + message.receiver_name +
                                '</a>');
                            var p = $('<p>').text(message.message);
                            var notificationRight = $('<div class="notification-right">').html(
                                '<i data-feather="x"></i>');
                ...
                initComplete: function() {
                    ...
                    api
                        ...
                        .each(function(colIdx) {
                            ...
                            if (title !== '') {
                                $(cell).html(
                                    '<input style="width: 140px;" type="text" placeholder="' +
                                    title + '" />');
                            }
