<x-guest-layout>
    ...
    <div class="page-wrapper">
        ...
        <section class="section-py-space layout-section" id="demo">
            <div class="container">
                <div class="row layout-block">
                    <div class="col-sm-12 wow pulse">
                        <div class="title"><a href="">Creative Layouts</a></div>
                    </div>
                    <div class="col-sm-12">
                        <ul class="nav nav-tabs layout-list" id="top-tab" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="light-link" data-bs-toggle="tab" href="#light-links" role="tab" aria-selected="true">Light Layout</a></li>
                            <li class="nav-item"><a class="nav-link" id="dark-link" data-bs-toggle="tab" href="#dark-links" role="tab" aria-selected="false">Dark Layout</a></li>
                            <li class="nav-item"><a class="nav-link" id="box-link" data-bs-toggle="tab" href="#box-links" role="tab" aria-selected="false">Box Layout</a></li>
                        </ul>
                        <div class="tab-content layout-links" id="top-tabContent">
        ...
        <section class="section-py-space demo-section light-bg section-px-space">
            <div class="container">
                <div class="row layout-block">
                    <div class="col-sm-12 wow pulse">
                        <div class="title">                      <a href="">Sidebar Type</a></div>
                    </div>
                </div>
        ...
        <!--sidebar section end-->
        <!-- frameworks start-->
        <section class="framework section-py-space bg-white" id="framework">
            <div class="custom-container">
                <div class="row">
                    <div class="col-sm-12 wow pulse">
                        <div class="title">                      <a href="">Top Frameworks</a></div>
                    </div>
        ...
        <!--frameworks end-->
        <!--Applications start-->
        <section class="demo-section section-py-space light-bg application-section" id="Applications">
            <div class="title"><a href="">Usefull application</a></div>
            <div class="container">
                <div class="row demo-block">
                    ...
                    <div class="col-lg-4 col-sm-6 wow pulse">
                        <div class="demo-box">
                            ...
                            <div class="demo-detail">
                                <div class="demo-title"><a class="btn" href="product-page.html" target="_blank">Ecommerce</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 wow pulse">
                    ...
                    <div class="col-lg-4 col-sm-6 wow pulse">
                        <div class="demo-box">
                            <div class="img-wrraper"><a href="chat.html" target="_blank"><img class="img-fluid" src="../assets/images/landing/application/12.jpg" alt=""></a></div>
                            <div class="demo-detail">
                    ...
                    <div class="col-lg-4 col-sm-6 wow pulse">
                        <div class="demo-box">
                            <div class="img-wrraper"><a href="email-application.html" target="_blank"><img class="img-fluid" src="../assets/images/landing/application/4.jpg" alt=""></a></div>
                            <div class="demo-detail">
                                <div class="demo-title"><a class="btn" href="email-application.html" target="_blank">Email Application</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 wow pulse">
        ...
        <section class="core-feature section-py-space" id="core-feature">
            <div class="title"><a href="">Unique Features</a></div>
            <div class="container">
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p>A lot of customized chart libraries</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--Core Feature end-->
        <!-- unique-cards start-->
        <section class="screenshot padding-top-bottom section-py-space light-bg" id="screenshot">
            <div class="title"><a href="">Responsive Design</a></div>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="counter-box">
                            <div>
                                ...
                                <div class="count-detail">
                                    <h4>Layouts  </h4>
                                    <p>Cion template has include light , dark , box & vertical layouts.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="counter-box">
                            <div>
                                ...
                                <div class="count-detail">
                                    <h4>Workable App</h4>
                                    <p>Cion template is comes with 10+ different clean modern & Usefully Application.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="counter-box">
                            <div>
                                ...
                                <div class="count-detail">
                                    <h4>Components</h4>
                                    <p>Cion admin template includes 42+ new and usefully Components.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="counter-box">
                            <div>
                                ...
                                <div class="count-detail">
                                    <h4>pages</h4>
                                    <p>Cion template is comes with 178+ different inner pages</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="landing-footer section-py-space light-bg" id="footer">
            <div class="custom-container">
                <div class="row">
                    <div class="col-12">
                        <div class="footer-contain"><img class="img-fluid" src="../assets/images/logo/logo-1.png" alt="">
